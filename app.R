  ...
  nav_panel(title = tags$h5(tags$b("Information and instructions")),
            ...
            card(
              ...
              card_body(
                ...
                p("We would also like to aknowledge Xin, Gray, Robles-Zurita et al. for open-sourcing their work (referenced below), which helped us develop this Shiny interface."),
                p(tags$a(href="https://link.springer.com/article/10.1007/s40258-021-00684-y",
                         icon("mouse-pointer", style="color:#2196c4"),
                         tags$strong("Xin, Y., Gray, E., Robles-Zurita, J.A. et al. From Spreadsheets to Script: Experiences From Converting a Scottish Cardiovascular Disease Policy Model into R. Appl Health Econ Health Policy 20, 149–158 (2022).",
                                     style="color:#2196c4"),
                         target="_blank")
                ),
                br(),
