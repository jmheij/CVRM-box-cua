...
# Acknowledgement: Much of the code used to implement the core model are adaptations of the tutorial code published in: 
...
# Medical Decision Making. 2023;43(1):21-41. https://doi.org/10.1177/0272989X221121747
...
run_model_uncontrolled_nohis <- function() {
  ...
  survival_plot <- ggplot(df_surv,
    ...
    theme_bw(base_size = 14) +
    theme()
  # ggsave("outputs/survival_UNcontrolled_nohis.jpg", survival_plot, width = 12, height = 8, units = "in")
...
run_model_controlled_yeshis <- function() {
  ...
  survival_plot <- ggplot(df_surv,
    ...
    theme_bw(base_size = 14) +
    theme()
  # ggsave("outputs/survival_controlled_yeshis.jpg", survival_plot, width = 12, height = 8, units = "in")
...
run_model_uncontrolled_yeshis <- function() {
  ...
  survival_plot <- ggplot(df_surv,
    ...
    theme_bw(base_size = 14) +
    theme()
  # ggsave("outputs/survival_UNcontrolled_YEShis.jpg", survival_plot, width = 12, height = 8, units = "in")
...
f_wrapper <- function(
  ...
  sg_prop_CN <- 0.447 # (89/199)
  sg_prop_UN <- 0.377 # (75/199)
  sg_prop_CY <- 0.126 # (25/199)
  sg_prop_UY <- 0.05 # (10/199)
...
fun_efficiency_gains <- function(controlled_prop,
  ...
  df_usage <- data.frame(
    ...
    GP_controlled = c(0.0079, 0.1755, 0.0355, 0.0021, 0.19450, 0.036),
    GP_uncontrolled = c(0.0121, 0.1965, 0.03250, 0.0021, 0.2505, 0.05),
    POH_controlled = c(0.1501, 3.3345, 0.6745, 0.0399, 3.6955, 0.684),
    POH_uncontrolled = c(0.2299, 3.7335, 0.6175, 0.0399, 4.7595, 0.95)
  )
